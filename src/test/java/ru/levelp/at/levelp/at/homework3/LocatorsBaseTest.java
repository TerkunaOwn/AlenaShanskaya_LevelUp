...
public class LocatorsBaseTest {
    ...
    protected final String URL_PAGE_DRAFT = "https://e.mail.ru/drafts/";
    ...
    protected final String URL_PAGE_SENT = "https://e.mail.ru/sent/";
    ...
    protected static final String PAGE_TITLE_TOMYSELF = "Письма себе - Почта Mail.ru";
