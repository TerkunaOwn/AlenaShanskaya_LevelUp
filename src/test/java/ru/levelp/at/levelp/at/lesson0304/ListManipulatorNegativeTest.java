package ru.levelp.at.levelp.at.lesson0304;
...
public class ListManipulatorNegativeTest {
    ...
    @Test(expectedExceptions = IllegalArgumentException.class) //ожидание ошибка
    ...
    @Test(expectedExceptions = IllegalArgumentException.class,
          expectedExceptionsMessageRegExp = "Список не может быть null.") //ожидание ошибка
