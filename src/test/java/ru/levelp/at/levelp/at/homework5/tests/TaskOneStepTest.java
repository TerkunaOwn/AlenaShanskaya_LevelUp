...
public class TaskOneTestStep extends HelperBase {
...
mailAgentStep.assertMail(properties.getProperty("ACCOUNT_LOGIN"), properties.getProperty("SUBJECT"), properties.getProperty("BODY_TEXT"));
//---------------------7. Отправить письмо
